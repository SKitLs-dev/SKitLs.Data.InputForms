...
namespace SKitLs.Data.InputForms.Notations
{
    ...
    public class BrowseDataAttribute : TextInputAttribute
    {
        ...
        public BrowseDataAttribute(string caption, string description, string? filter = "All files (*.*)|*.*", bool isNecessary = true, string? initialDirectory = null, string? browserTitle = null, string? previewMethodName = null) : base(caption, description, isNecessary, previewMethodName)
        {
            Filter = filter;
        ...
        /// <param name="isNecessary">Indicates whether the field is necessary. Defaults to true.</param>
        ...
        public BrowseDataAttribute(string? filter = "All files (*.*)|*.*", bool isNecessary = true, string? initialDirectory = null, string? browserTitle = null, string? previewMethodName = null) : base(isNecessary, previewMethodName)
        {
            Filter = filter;
            InitialDirectory = initialDirectory;
            BrowserTitle = browserTitle;
